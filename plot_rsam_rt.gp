...
while (1) {
    ...
    set title "MSS1.SHZ RSAM" font ", 20" offset 0,-2
    ...
    set title "MBLY.EHZ RSAM" font ", 20" offset 0,-2
    ...
    set title "MBGH.EHZ RSAM" font ", 20" offset 0,-2
    ...
    set title "MBWH.EHZ RSAM" font ", 20" offset 0,-2
